...
// import { PETS, MEDICAL_RECORDS } from "../../data/mockData";
// import { Search, Download, X, CheckCircle2, AlertCircle } from "lucide-react";

// export default function DoctorPetHistory() {
//   const [searchId, setSearchId] = useState("");
//   const [foundPet, setFoundPet] = useState<typeof PETS[0] | null>(null);
//   const [notFound, setNotFound] = useState(false);

//   const handleSearch = () => {
//     if (!searchId.trim()) return;
//     const pet = PETS.find(
//       (p) => p._id === searchId.trim() || p.name.toLowerCase().includes(searchId.toLowerCase())
//     );
//     if (pet) {
//       setFoundPet(pet);
//       setNotFound(false);
...
//   const petRecords = foundPet
//     ? MEDICAL_RECORDS.filter((r) => r.petId === foundPet._id)
//     : [];

//   return (
//     <div className="p-6 lg:p-8 max-w-5xl mx-auto">
//       <div className="mb-8">
//         <h1 className="text-2xl font-bold text-gray-900">View Pet History</h1>
//         <p className="text-gray-500 mt-1">Search for a pet and view its complete consultation history</p>
//       </div>
...
//             />
//           </div>
//           <button onClick={handleSearch} className="px-6 py-2.5 bg-teal-600 hover:bg-teal-700 text-white rounded-xl text-sm font-medium cursor-pointer transition">
//             Search
//           </button>
//           {foundPet && (
//             <button onClick={() => { setFoundPet(null); setSearchId(""); }} className="p-2.5 border border-gray-200 rounded-xl hover:bg-gray-50 cursor-pointer">
//               <X className="w-4 h-4 text-gray-500" />
//             </button>
//           )}
//         </div>
//         <div className="flex flex-wrap gap-2">
//           <p className="text-xs text-gray-400 w-full">Quick search:</p>
//           {PETS.map((p) => (
//             <button key={p._id} onClick={() => setSearchId(p._id)}
...
//             <h2 className="font-bold text-gray-900 mb-4">Pet Profile</h2>
...
//                   { label: "Contact", value: foundPet.ownerContact },
//                   { label: "Last Checkup", value: foundPet.lastCheckup },
//                 ].map(({ label, value }) => (
...
//                     {foundPet.vaccinated ? "Vaccinated" : "Unvaccinated"}
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//                         <span className="text-xs bg-teal-50 text-teal-700 px-2 py-0.5 rounded-full">{rec.type}</span>
//                       </td>
//                       <td className="py-3">
...
import { Search, Heart, Download, X, CheckCircle2, AlertCircle } from "lucide-react";
